...
export default function Portfolio() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Show API key modal immediately if no keys are present */}
      {!apiKey || !apiSecret ? (
        <ApiKeyModal />
      ) : (
        <>
          ...
          {!loading && !balances && (
            <div className="bg-gray-800 rounded-lg p-6">
              <div className="text-center">
                <h2 className="text-xl font-semibold mb-4">Loading Portfolio Data</h2>
                <p className="text-gray-400 mb-6">Fetching your assets from Bybit...</p>
